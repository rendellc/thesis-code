...
\includepdf[pages=-,pagecommand={},width=\textwidth]{sideslip.pdf}
...
\todo[inline]{Need to rotate these forces to align with wheel rotation to compute $F_{WL}$}
...
\improve[inline]{\Cref{fig:axle-load-during-acceleration} and \cref{fig:wheel-load-shifting-during-cornering} assume no roll and pitch. Probably suitable for control model, but should derive equations with roll and pitch for simulation}
