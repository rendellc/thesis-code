...
: ${AMENT_CURRENT_PREFIX:="/home/cale/thesis-code/ws/src/install/simulator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/simulator/environment/library_path.sh"
