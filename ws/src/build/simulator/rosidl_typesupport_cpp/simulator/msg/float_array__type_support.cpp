...
static const _FloatArray_type_support_symbol_names_t _FloatArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simulator, msg, FloatArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simulator, msg, FloatArray)),
  }
};
...
{
  return &::simulator::msg::rosidl_typesupport_cpp::FloatArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, simulator, msg, FloatArray)() {
  return get_message_type_support_handle<simulator::msg::FloatArray>();
}
