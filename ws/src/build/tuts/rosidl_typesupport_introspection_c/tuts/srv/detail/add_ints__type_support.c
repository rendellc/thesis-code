...
#include <stddef.h>
#include "tuts/srv/detail/add_ints__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tuts__srv__AddInts_Request__init(message_memory);
}

void AddInts_Request__rosidl_typesupport_introspection_c__AddInts_Request_fini_function(void * message_memory)
{
  tuts__srv__AddInts_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember AddInts_Request__rosidl_typesupport_introspection_c__AddInts_Request_message_member_array[3] = {
  {
    "a",  // name
    ...
    offsetof(tuts__srv__AddInts_Request, a),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tuts__srv__AddInts_Request, b),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tuts__srv__AddInts_Request, c),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers AddInts_Request__rosidl_typesupport_introspection_c__AddInts_Request_message_members = {
  "tuts__srv",  // message namespace
  "AddInts_Request",  // message name
  3,  // number of fields
  sizeof(tuts__srv__AddInts_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tuts, srv, AddInts_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember AddInts_Response__rosidl_typesupport_introspection_c__AddInts_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tuts__srv__AddInts_Response, sum),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers AddInts_Response__rosidl_typesupport_introspection_c__AddInts_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(tuts__srv__AddInts_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_tuts
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tuts, srv, AddInts_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers tuts__srv__detail__add_ints__rosidl_typesupport_introspection_c__AddInts_service_members = {
  "tuts__srv",  // service namespace
  "AddInts",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // tuts__srv__detail__add_ints__rosidl_typesupport_introspection_c__AddInts_Request_message_type_support_handle,
  NULL  // response message
  // tuts__srv__detail__add_ints__rosidl_typesupport_introspection_c__AddInts_Response_message_type_support_handle
};

static rosidl_service_type_support_t tuts__srv__detail__add_ints__rosidl_typesupport_introspection_c__AddInts_service_type_support_handle = {
  0,
  &tuts__srv__detail__add_ints__rosidl_typesupport_introspection_c__AddInts_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tuts, srv, AddInts)() {
  if (!tuts__srv__detail__add_ints__rosidl_typesupport_introspection_c__AddInts_service_type_support_handle.typesupport_identifier) {
    tuts__srv__detail__add_ints__rosidl_typesupport_introspection_c__AddInts_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)tuts__srv__detail__add_ints__rosidl_typesupport_introspection_c__AddInts_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tuts, srv, AddInts_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tuts, srv, AddInts_Response)()->data;
  }

  return &tuts__srv__detail__add_ints__rosidl_typesupport_introspection_c__AddInts_service_type_support_handle;
}
