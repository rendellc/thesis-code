...
#include "tuts/srv/detail/add_ints__rosidl_typesupport_fastrtps_c.h"
...
#include "tuts/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _AddInts_Request__ros_msg_type = tuts__srv__AddInts_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tuts
size_t get_serialized_size_tuts__srv__AddInts_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddInts_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tuts__srv__AddInts_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tuts
size_t max_serialized_size_tuts__srv__AddInts_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_tuts__srv__AddInts_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tuts, srv, AddInts_Request)() {
...
using _AddInts_Response__ros_msg_type = tuts__srv__AddInts_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tuts
size_t get_serialized_size_tuts__srv__AddInts_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddInts_Response__ros_msg_type * ros_message = static_cast<const _AddInts_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_tuts__srv__AddInts_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tuts
size_t max_serialized_size_tuts__srv__AddInts_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_tuts__srv__AddInts_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tuts, srv, AddInts_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tuts, srv, AddInts)() {
