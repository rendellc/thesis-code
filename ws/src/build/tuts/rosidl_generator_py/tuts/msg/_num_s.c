...
bool tuts__msg__num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tuts.msg._num.Num", full_classname_dest, 17) == 0);
  }
  tuts__msg__Num * ros_message = _ros_message;
  {  // value
...
PyObject * tuts__msg__num__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tuts.msg._num");
