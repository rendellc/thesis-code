...
bool tuts__srv__add_ints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tuts.srv._add_ints.AddInts_Request", full_classname_dest, 34) == 0);
  }
  tuts__srv__AddInts_Request * ros_message = _ros_message;
  {  // a
...
PyObject * tuts__srv__add_ints__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tuts.srv._add_ints");
...
ROSIDL_GENERATOR_C_EXPORT
bool tuts__srv__add_ints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tuts.srv._add_ints.AddInts_Response", full_classname_dest, 35) == 0);
  }
  tuts__srv__AddInts_Response * ros_message = _ros_message;
  {  // sum
