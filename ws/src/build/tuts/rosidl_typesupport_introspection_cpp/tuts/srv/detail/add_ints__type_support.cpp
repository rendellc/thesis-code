...
{
  new (message_memory) tuts::srv::AddInts_Request(_init);
}

void AddInts_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tuts::srv::AddInts_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddInts_Request_message_member_array[3] = {
  {
    ...
    offsetof(tuts::srv::AddInts_Request, a),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tuts::srv::AddInts_Request, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tuts::srv::AddInts_Request, c),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AddInts_Request_message_members = {
  "tuts::srv",  // message namespace
  "AddInts_Request",  // message name
  3,  // number of fields
  sizeof(tuts::srv::AddInts_Request),
...
{
  return &::tuts::srv::rosidl_typesupport_introspection_cpp::AddInts_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tuts, srv, AddInts_Request)() {
  return &::tuts::srv::rosidl_typesupport_introspection_cpp::AddInts_Request_message_type_support_handle;
}
...
void AddInts_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) tuts::srv::AddInts_Response(_init);
}

void AddInts_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tuts::srv::AddInts_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddInts_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tuts::srv::AddInts_Response, sum),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AddInts_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(tuts::srv::AddInts_Response),
...
{
  return &::tuts::srv::rosidl_typesupport_introspection_cpp::AddInts_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tuts, srv, AddInts_Response)() {
  return &::tuts::srv::rosidl_typesupport_introspection_cpp::AddInts_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers AddInts_service_members = {
  "tuts::srv",  // service namespace
  "AddInts",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<tuts::srv::AddInts>()
...
get_service_type_support_handle<tuts::srv::AddInts>()
{
  ...
  auto service_type_support =
    &::tuts::srv::rosidl_typesupport_introspection_cpp::AddInts_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tuts, srv, AddInts)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<tuts::srv::AddInts>();
}
