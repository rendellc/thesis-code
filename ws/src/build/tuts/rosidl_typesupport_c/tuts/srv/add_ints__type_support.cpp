...
#include "tuts/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _AddInts_Request_type_support_symbol_names_t _AddInts_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tuts, srv, AddInts_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tuts, srv, AddInts_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_tuts
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tuts, srv, AddInts_Request)() {
  return &::tuts::srv::rosidl_typesupport_c::AddInts_Request_message_type_support_handle;
}
...
static const _AddInts_Response_type_support_symbol_names_t _AddInts_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tuts, srv, AddInts_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tuts, srv, AddInts_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_tuts
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tuts, srv, AddInts_Response)() {
  return &::tuts::srv::rosidl_typesupport_c::AddInts_Response_message_type_support_handle;
}
...
static const _AddInts_type_support_symbol_names_t _AddInts_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tuts, srv, AddInts)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tuts, srv, AddInts)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tuts, srv, AddInts)() {
  return &::tuts::srv::rosidl_typesupport_c::AddInts_service_type_support_handle;
}
